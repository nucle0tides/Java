...
public class PolarAngleComparator implements Comparator<Point> 
{
	 ...
	 *         
	 *         b) neither p1 nor p2 equals referencePoint, 
	 *         and the polar angle of p1 with respect to referencePoint is less than that of p2; 
	 *         
	 *         c) neither p1 nor p2 equals referencePoint, p1 and p2 have the same polar angle w.r.t.
	...
	public int compare(Point p1, Point p2) {
		boolean a = p1.equals(referencePoint); 
		boolean b = (!p1.equals(referencePoint) && !p2.equals(referencePoint)) && (comparePolarAngle(p1, p2) < 0); 
		boolean c = (!p1.equals(referencePoint) && !p2.equals(referencePoint)) && (comparePolarAngle(p1, p2) == 0) && (compareDistance(p1, p2) < 0); 
		if (p1.equals(p2))
		{ 
			return 0; 
		}
	...
	{
		int p1Distance = dotProduct(p1,p1); 
	...
	{
		int a = (p1.getX() - referencePoint.getX()) * (p2.getY() - referencePoint.getY()); 
		int b = (p2.getX() - referencePoint.getX()) * (p1.getY() - referencePoint.getY()); 
		return a - b; 
	}
	...
	{
		int a = (p1.getX() - referencePoint.getX()) * (p2.getX() - referencePoint.getX()); 
		int b = (p1.getY() - referencePoint.getY()) * (p2.getY() - referencePoint.getY()); 
		return a + b; 
	}
}
