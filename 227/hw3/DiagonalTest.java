...
public class DiagonalTest {
	...
	public void setUp() throws Exception {
		...
		colors[0] = Color.RED;
		colors[1] = Color.BLUE;
		d = new DiagonalPiece(new Position(2, 5), colors);
	}
