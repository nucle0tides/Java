...
public class LPieceTest {
	...
	public void setUp() throws Exception {
		...
		colors[3] = Color.CYAN;
		d = new LPiece(new Position(2, 5), colors);
	}
	...
	public void testConstruction() {
		blocks = d.getBlocks();
		String expected = "[[R, (2, 5)], [B, (2, 6)], [O, (3, 6)], [C, (4, 6)]]";
	...
	public void testTransform() {
		...
		assertEquals(expected, d.getPosition().toString());
		blocks = d.getBlocks();
		expected = "[[R, (2, 7)], [B, (2, 6)], [O, (3, 6)], [C, (4, 6)]]";
		assertEquals(expected, Arrays.toString(blocks));
		...
		assertEquals(expected, d.getPosition().toString());
		blocks = d.getBlocks();
		expected = "[[R, (2, 5)], [B, (2, 6)], [O, (3, 6)], [C, (4, 6)]]";
		assertEquals(expected, Arrays.toString(blocks));
	}
	...
	public void testShiftingBlocks() {
		...
		d.shiftRight();
		blocks = d.getBlocks();
		String expected = "[[R, (3, 7)], [B, (3, 8)], [O, (4, 8)], [C, (5, 8)]]";
		assertEquals(expected, Arrays.toString(blocks));
	}
	...
	public void testInitializingPosition() {
		...
		assertEquals(expected, d.getPosition().toString());
		blocks = d.getBlocks();
		expected = "[[R, (5, 5)], [B, (5, 6)], [O, (6, 6)], [C, (7, 6)]]";
		assertEquals(expected, Arrays.toString(blocks));
	}
	...
	public void testCycling() {
		d.cycle();
		blocks = d.getBlocks();
		String expected = "[[C, (2, 5)], [R, (2, 6)], [B, (3, 6)], [O, (4, 6)]]";
		assertEquals(expected, Arrays.toString(blocks));
	}
