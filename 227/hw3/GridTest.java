...
public class GridTest
{
  public static void main(String[] args)
  {
    ...
    game = new BlockGame(new SampleGenerator(), rand);
//    game = new BlockGame(new SampleGenerator());
    ...
    grid[16][6] = new GridCell(Color.RED);
    
    grid[22][4] = new GridCell(Color.MAGENTA);
    grid[22][6] = new GridCell(Color.MAGENTA);
    
    grid[22][0] = new GridCell(Color.ORANGE);
    ...
    printGrid(grid);
    System.out.println();
    System.out.println("Score: " + game.determineScore());
  }
